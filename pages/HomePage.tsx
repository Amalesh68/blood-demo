    ...
    <div className="animate-fade-in-up">
      ...
      <section className="relative bg-white pt-20 pb-24 text-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link to="/donors" className="w-full sm:w-auto bg-brand-red text-white font-semibold px-8 py-4 rounded-full hover:bg-brand-red-dark transition-all duration-300 transform hover:scale-105 shadow-lg">
              Find a Donor
            </Link>
            <Link to="/request" className="w-full sm:w-auto bg-white text-brand-dark font-semibold px-8 py-4 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg border border-gray-200">
              Request Blood
            </Link>
          </div>
        </div>
      ...
      <section className="bg-brand-red text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="bg-white text-brand-red font-bold px-10 py-4 rounded-full hover:bg-red-50 transition-all duration-300 transform hover:scale-105 shadow-lg">
            Become a Donor
          </button>
        </div>
      </section>
