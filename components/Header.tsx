      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <button className="bg-brand-red text-white font-semibold px-6 py-2 rounded-full hover:bg-brand-red-dark transition-all duration-300 transform hover:scale-105">
              Register
            </button>
          </div>
